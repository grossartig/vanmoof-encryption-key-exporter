...
export default function Home() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!privacyPolicyAgreed) {
      // Display error message or handle not agreeing to the privacy policy
      return;
    }
  ...
  const exportData = () => {
    if (bikes) {
      const content = JSON.stringify(bikes);
      const filename = "bikeData_" + (new Date()).toISOString().replaceAll(":", "-") + ".json";
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                          <label htmlFor="privacyPolicyAgreement">
                            ...
                            />
                            I agree to the <a href="https://grossartig.io/keyexport/privacy">data privacy policy</a>
                          </label>
                        </Grid>
                        <Grid item xs={12}>
                          <Button
          ...
          <footer>
            <Box sx={{ mt: 3 }}>
              <Typography variant="body2" color="textSecondary" align="center">
                <center>
                  <a href="https://grossartig.io/keyexport/legalnotice">Legal Notice (Impressum)</a> | <a href="https://grossartig.io/keyexport/privacy">Privacy Policy</a><br /><br />
				  This project is <a href="https://github.com/grossartig/vanmoof-encryption-key-exporter">open source.</a><br /><br />
